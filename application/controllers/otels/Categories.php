...
class Categories extends CI_Controller {
	...
	public function detail($ana_cat_name=null)
	{
		...
		$ana_cat_name=trim($ana_cat_name); $ana_cat_name=htmlentities($ana_cat_name); $ana_cat_name=strip_tags($ana_cat_name); 	
		$this->load->model('otel/Categories_model');
	...
	if($this->session->userdata('lng_turu')=="Ru"){  $uz="_ru"; $data["uz"]="_ru"; } 
	   ...
	   $dongu=$adet-1;
		...
		$this->load->view('otel/anakategori',$data);
