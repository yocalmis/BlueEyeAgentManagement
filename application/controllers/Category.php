...
class Category extends CI_Controller {
	...
	if($this->session->userdata('lng_turu')=="Esp"){  $uz="_esp"; $data["uz"]="_esp"; } 		
		...
		$data["ust_kat_bilgi_getir"]=$this->Category_model->ust_kat_bilgi_getir($dizi["ust_kategori_id"],$uz);	

		 $data["ust_kat_adi"]=$this->Category_model->ust_kat_adi($dizi["ust_kategori_id"],$uz);	
	...
	// print_r($data["yorum_puan_ortalama"]);
	 ...
	 //Alt kategorinin ana kategorisine ait turlar		
		...
		$data["populer_tur"]=$this->Category_model->populer_tur();	
     	...
     	$this->load->view('altkategori',$data);
