...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (empty($online)) {
            ...
            if ($sonuc) {$this->load->view('admin/admin_login');} else { $this->load->view('admin/admin_register');}
...
//Do your cool stuff here . You don't need any State info you are in add
    ...
    public function insert_seo($post_array)
    {
    ...
    public function kisi_fiyat($tur_kod = null, $id = null)
    {
        ...
        if (empty($online)) {
            ...
            $crud->columns('tur_kod', 'bas_tarih', 'bit_tarih', 'bas_kisi', 'bit_kisi', 'yetiskin_fiyat', 'cocuk_fiyat', 'bebek_fiyat');
 ...
 */
    ...
    public function rez_onay($post_array, $primary_key = null)
    {
        $online = $this->session->userdata('adminonline');
        if (empty($online)) {
            $this->load->library('messages');
    ...
    public function kart_durum_guncelle($post_array, $primary_key)
    {
    ...
    public function kod_olustur_kampanya($post_array)
    {
