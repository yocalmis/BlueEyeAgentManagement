...
class Admin_model extends CI_Model
{
    ...
    public function admin_register_before($username)
    {
    ...
    public function admin_status_getir($user)
    {

        $query = $this->db->query("select * from tkn_mat_admin Where username='$user'");
    ...
    public function tur_return_id($id)
    {
    ...
    public function tur_detay_return($tur_kod, $id)
    {
    ...
    public function tur_return_adi($adi)
    {
    ...
    public function tur_turu_kod($id)
    {
    ...
    public function otel_fiyat_say($id)
    {
    ...
    public function tur_kontrol($id, $kod, $adi)
    {
    ...
    public function kart_kullanici_getir($id)
    {

        $sql = "SELECT * FROM acente_kart Where id=" . $id;
        $query = $this->db->query($sql);

        if ($query->num_rows() > 0) {
            foreach ($query->result_array() as $row) {
                return $row['kullanici_id'];
            }
    ...
    public function kullanici_mail_getir($id)
    {
    ...
    public function resim_sil($foto_id, $tur_id, $foto_adi)
    {
    ...
    public function resim_kaydet($id, $name, $kod)
    {
    ...
    public function kategori_resim_query($primary_key)
    {
    ...
    public function tur_resim_query($primary_key)
    {
    ...
    public function tur_yorum_sil($primary_key)
    {
    ...
    public function tur_istek_sil($primary_key)
    {
    ...
    public function tur_detay_sil($kod)
    {
    ...
    public function tur_foto_getir($primary_key)
    {
    ...
    public function onrez_detay_getir($id)
    {
    ...
    public function onrez_getir($id)
    {
    ...
    public function turlar_getir($adi)
    {

        $sql = "SELECT id,sorting,adi FROM acente_tur Where tur_donemi='" . $adi . "' order by sorting asc";
        $query = $this->db->query($sql);
    ...
    public function turlar_sira_update($sira, $id)
    {

        $query = $this->db->query("update acente_tur set sorting=" . $sira . " Where id=" . $id);
        if ($query) {return 1;} else {return 0;}

    }

    public function iptal_guncelle($kul_id, $tur_id, $durum)
    {
