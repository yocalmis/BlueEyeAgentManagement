...
class Admin_model extends CI_Model
{
    ...
    {return 1;}    else{return 0;}
				...
				function admin_status_getir($user)   {
...
foreach ($query->result_array() as $row)
{
    ...
    {return 1;}    
	     ...
	     function kart_kullanici_getir($id)
    {
        ...
        else
        {
	     ...
	     function kullanici_mail_getir($id)
    {
	   ...
	   function turlar_getir($adi)
    {
        ...
        else
        {
            return FALSE;
	 	 	  ...
	 	 	  function turlar_sira_update($sira,$id)
     {
