...
class Rez_model extends CI_Model
{
    ...
    public function rez_getir($kul_id)
    {
    ...
    public function yorum_adet($kod)
    {
    ...
    public function tarih_degistir($array)
    {
    ...
    public function tarih_degisim_kontrol($array)
    {
    ...
    public function iptal_et($array)
    {
