...
class Tour_model extends CI_Model
{
    ...
    public function istek_varmi($t_id, $kul_id)
    {
    ...
    public function tur_engel_tarih($t_id)
    {
    ...
    public function yorum_puan_ortalama($tur_id, $kullanici_id)
    {
    ...
    public function tur_detay($t_kod)
    {
    ...
    public function alt_kat_diger_turlar($kat_id)
    {
    ...
    public function alt_kat_adi($kat_id, $lng, $uz)
    {
    ...
    public function ust_kat_adi($kat_id, $lng, $uz)
    {
    ...
    public function alt_kat_seo_adi($kat_id)
    {
    ...
    public function ust_kat_seo_adi($kat_id)
    {
    ...
    public function alt_kat_diger_turlar_fiyat($tur_kod)
    {
    ...
    public function alt_kat_diger_turlar_yorum_adet($tur_kod)
    {
    ...
    public function tur_gecmis_kayit($t_id, $kul_id)
    {
/*
 ...
 */
    ...
    public function yorum_kayit($baslik, $yorum, $kul_id, $tur_id, $tur_kod, $servis, $organ, $para, $guven, $seo_adi)
    {
/*
$into=$this->db->where('tur_id',$id);
$into=$this->db->where('kullanici_id',$kul_id);
 ...
 */
    ...
    public function puan_kayit($kul_id, $tur_kod, $servis, $organ, $para, $guven)
    {
/*
$into=$this->db->where('tur_id',$id);
$into=$this->db->where('kullanici_id',$kul_id);
 ...
 */
    ...
    public function yorum_kullanici($kul_id)
    {
    ...
    public function yorum_tur($tur_id)
    {
    ...
    public function tur_kontrol($tur_id)
    {
    ...
    public function tur_detay_kontrol($fiyat_aralik__yet_ID, $fiyat_aralik__cck_ID, $fiyat_aralik__bbk_ID, $yetiskin_tek_fiyat, $cocuk_tek_fiyat, $bebek_tek_fiyat, $yetiskin_adet, $cocuk_adet, $bebek_adet, $yetis_top_fiyat, $cocuk_top_fiyat, $bebek_top_fiyat)
    {
    ...
    public function tur_detay_kontrol_2($fiyat_aralik__yet_ID, $fiyat_aralik__cck_ID, $fiyat_aralik__bbk_ID, $yetis_top_fiyat, $cocuk_top_fiyat, $bebek_top_fiyat)
    {
    ...
    public function tur_turu_kontrol($tur_kod, $tur_id, $tur_turu)
    {
    ...
    public function tur_odeme_kontrol($tur_id)
    {
    ...
    public function belirli_tarih_kontrol($tur_detay_id, $bas_t, $bit_t)
    {
    ...
    public function surekli_tarih_kontrol($tur_detay_id, $bas_s, $bit_s)
    {
    ...
    public function sepet_ekle($kul_id, $tur_id, $tur_kod, $tur_detay_id, $yetiskin_adet, $cocuk_adet, $bebek_adet, $genel_total, $bas_t, $bit_t, $bas_s, $bit_s, $indirimsiz)
    {
    ...
    public function rez_ekle($kul_id, $tur_id, $tur_kod, $tur_detay_id, $bebek_adet, $yetiskin_adet, $cocuk_adet, $genel_total, $bas_t, $bit_t, $bas_s, $bit_s, $indirimsiz)
    {
    ...
    public function kisi_fiyat($tur_kod, $id)
    {
