...
<body class="nonf">
		...
		<div class="container">
			<section class="c-brdcrmb">
				<h4>
					...
					<?php echo $this->session->userdata('lng')["gcms_bslk"];?>
				</h4>
			</section>
			<p></p>
			...
			<section class="result-main none-shadow">
					...
					<?php $n=0;	if( $history ) :  foreach( $history as $dizi ) :   ?>
						<div class="s-b-c-i">
							...
							<div class="b-c-t-i">
								...
								<p>
									...
									<div class="choose-other">
										<div class="stars"> <?php echo $puan1=$puan[$dizi["kod"]]["tur_puan_genel"];  ?>
	...
	echo "<span data-url='".icons_url."star_border.svg'></span>";
					...
					?>	
										...
										<span> <?php echo $dizi["yorum_adet"];  ?> <?php echo $this->session->userdata('lng')["onrln_ktgr_yrm"]; ?></span>
									</div>
								</p>
							...
							<div class="b-c-b-i">
								<div class="timeprice">
									<span class="other-duration">
										<span class="other-duration__icon">
											<?php echo "<span data-url='".icons_url."outline-history-24px.svg'></span>";?>
										</span>
