		...
		<div class="places-row">
			<!-- İndirim varsa -->
				...
				<div class="other-image">
					...
					class="lazy" alt="Kapadokya mix tur" />
				</div>
				<div class="other-text-inner">
					<a>
						Kapadokya mix tur					</a>
			...
			<div class="places-row">				<div class="other-main
				...
				<div class="other-image">
					...
					src="https://www.blueeyetour.com/assets_user/img/placeholder.svg"
					data-src="https://www.blueeyetour.com/assets/resimler/turlar/4a42e-deve-turu-11.jpg"
					class="lazy" alt="Kapadokya Deve Turu ( 2 saat)" />
				</div>
				<div class="other-text-inner">
					<a>
						Kapadokya Deve Turu ( 2 saat)					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
				...
				<div class="other-image">
					...
					class="lazy" alt="Kapadokya Bölge Turu (Kırmızı tur)" />
				</div>
				<div class="other-text-inner">
					<a>
						Kapadokya Bölge Turu (Kırmızı tur)					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
