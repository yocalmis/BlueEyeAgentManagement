	...
	<div class="places-other">
		<div class="places-row">
			...
			<div class="places-row">				<div class="other-main
				...
				<a href="https://www.blueeyetour.com/Tour/detail/Byzantine-Relics-Tour-Half-Day-Morning-"></a>
				<div class="other-image">
					<img 
					src="https://www.blueeyetour.com/assets_user/img/placeholder.svg"
					data-src="https://www.blueeyetour.com/assets/resimler/turlar/40d55-jeison-higuita-n9dxy6fifdw-unsplash.jpg"
					class="lazy" alt="Byzantine Relics Tour (Half Day Morning) " />
				</div>
				<div class="other-text-inner">
					<a>
						Byzantine Relics Tour (Half Day Morning) 					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
