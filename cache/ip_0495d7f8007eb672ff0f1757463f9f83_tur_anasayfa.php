		...
		<div class="places-row">
			...
			<div class="places-main">
				<div class="places-main__image">
					...
					class="lazy" alt="Turkey Package Tours " />
				</div>
				<div class="places-main-text">				<h4>Turkey Package Tours </h4>

				<p><p>
	Turkey Tours</p>
</p>
				<a class="btn" href="
				https://www.blueeyetour.com/Categories/detail/Turkey-Package-Tours-">
				Explore More			</a>
		</div>
	</div>
	<div class="places-other">
		<div class="places-row">
			...
			<div class="places-main">
				<div class="places-main__image">
					...
					class="lazy" alt="Safranbolu" />
				</div>
				<div class="places-main-text smoth">				<h4>Safranbolu</h4>

				<p><p>
	<span style="font-size:16px;"><span style="font-family:verdana,geneva,sans-serif;">Welcome to Safranbolu.</span></s</p>
				<a class="btn" href="
				https://www.blueeyetour.com/Categories/detail/Safranbolu">
				Explore More			</a>
		</div>
	</div>
	<div class="places-other">
