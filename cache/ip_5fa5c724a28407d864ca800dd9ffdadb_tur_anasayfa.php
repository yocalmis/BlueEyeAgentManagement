		...
		<div class="places-row">
			<!-- İndirim varsa -->
				...
				<div class="other-image">
					...
					class="lazy" alt="Boğaz ve İki Kıta Turu (Tam Gün)" />
				</div>
				<div class="other-text-inner">
					<a>
						Boğaz ve İki Kıta Turu (Tam Gün)					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
				...
				<div class="other-image">
					...
					class="lazy" alt="İstanbul Atatürk Havalimanı Transferi (Özel Servis)" />
				</div>
				<div class="other-text-inner">
					<a>
						İstanbul Atatürk Havalimanı Transferi (Özel Servis)					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
			...
			<div class="places-row">				<div class="other-main
				...
				<div class="other-image">
					...
					class="lazy" alt="İstanbul Sabiha Gökçen Havalimanı Transferi (Özel Servis)" />
				</div>
				<div class="other-text-inner">
					<a>
						İstanbul Sabiha Gökçen Havalimanı Transferi (Özel Servis)					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
				...
				<div class="other-image">
					...
					class="lazy" alt="Beylerbeyi Sarayı Turu (Yarım Gün Öğleden Sonra)" />
				</div>
				<div class="other-text-inner">
					<a>
						Beylerbeyi Sarayı Turu (Yarım Gün Öğleden Sonra)					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
				...
				<div class="top-places-item">
					<a href="https://www.blueeyetour.com/Category/detail/Safranbolu-Tours">
						<figure>
							...
							class="lazy"
							alt="Safranbolu Turları">
						</figure>
						<h5>Safranbolu Turları</h5>
					</a>
				</div>
