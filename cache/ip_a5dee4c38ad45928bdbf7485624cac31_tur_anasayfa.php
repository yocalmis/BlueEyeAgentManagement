	...
	<div class="places-other">
		<div class="places-row">
			...
			<div class="places-main">
				...
				<div class="places-main-text">				<h4>Памуккале</h4>
		...
		<div class="places-row">
			...
			<div class="places-main">
				<div class="places-main__image">
					...
					class="lazy" alt="Стамбул" />
				</div>
				<div class="places-main-text smoth">				<h4>Стамбул</h4>
		...
		<div class="places-row">
			<!-- İndirim varsa -->
				...
				<div class="other-image">
					...
					class="lazy" alt="Тур по Босфору и двум континентам (на целый день)." />
				</div>
				<div class="other-text-inner">
					<a>
						Тур по Босфору и двум континентам (на целый день).					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
			...
			<div class="places-row">				<div class="other-main
				...
				<div class="other-image">
					...
					class="lazy" alt="Тур по Дворцу Бейлербей (на полдня, после обеда)" />
				</div>
				<div class="other-text-inner">
					<a>
						Тур по Дворцу Бейлербей (на полдня, после обеда)					</a>
					<div class="bottom-inner">
						<div class="other-left">
							<div class="stars">
				...
				<div class="topEvents">
					...
					<div class="t-e-inner">
						<div class="t-e-r">
								...
								<!-- icon implementation in function.js/425 -->
								<span class="t-e__icon"></span>
								<span>(Специальный) дневной тур из Каппадокии в Анкару </span>
							</a>
